  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <h1 className="mt-1 font-heading text-3xl font-semibold tracking-tight">Contacts</h1>
        <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
          Contact data is loaded from DummyJSON through the shared HTTP client and cached by
          TanStack Query.
        </p>
      </div>
